...
import org.apache.phoenix.pherf.workload.continuous.tenantoperation.TenantOperationWorkload;
...
public class Pherf {
    ...
    static {
        ...
        options.addOption("c", "continous", false,
                "Long running loads data according to specified configuration values.");
    ...
    private final boolean continousLoad;
    ...
    public Pherf(String[] args) throws Exception {
        ...
        continousLoad = command.hasOption("c");
