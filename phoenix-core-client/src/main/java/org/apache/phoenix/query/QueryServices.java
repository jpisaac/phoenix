...
public interface QueryServices extends SQLCloseable {
    ...
    //Property to know whether TTL at View Level is enabled for tenants
    public static final String PHOENIX_VIEW_TTL_FOR_TENANTS_ENABLED = "phoenix.view.ttl.tenants.enabled";
