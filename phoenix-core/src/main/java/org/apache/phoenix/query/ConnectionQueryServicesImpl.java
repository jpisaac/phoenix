...
public class ConnectionQueryServicesImpl extends DelegateQueryServices implements ConnectionQueryServices {
    ...
    public void closeAllConnections(SQLExceptionInfo.Builder reasonBuilder) {
        // TODO: Do we want to deep copy the connectionQueues if we are concerned about another thread accessing it?
     ...
     * @throws SQLException
     */
    private HTableDescriptor ensureTableCreated(byte[] physicalTableName, byte[] parentPhysicalTableName, PTableType tableType,
