...
public class QueryServicesOptions {
    ...
    public static final boolean DEFAULT_CLIENT_SIDE_MASKING_ENABLED = false;
    public static final boolean DEFAULT_SERVER_SIDE_MASKING_ENABLED = !DEFAULT_CLIENT_SIDE_MASKING_ENABLED;
    ...
    public static QueryServicesOptions withDefaults() {
        ...
        QueryServicesOptions options = new QueryServicesOptions(config)
            ...
            .setIfUnset(PHOENIX_TTL_CLIENT_SIDE_MASKING_ENABLED, DEFAULT_CLIENT_SIDE_MASKING_ENABLED)
    ...
    public boolean isClientSideMaskingEnabled() {
        return config.getBoolean(PHOENIX_TTL_CLIENT_SIDE_MASKING_ENABLED, DEFAULT_CLIENT_SIDE_MASKING_ENABLED);
    }

    public QueryServicesOptions setClientSideMaskingEnabled(boolean flag) {
        config.setBoolean(PHOENIX_TTL_CLIENT_SIDE_MASKING_ENABLED, flag);
        return this;
    }
