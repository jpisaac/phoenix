 ...
 */
public class PJson extends PVarchar{

    public static final PJson INSTANCE = new PJson();

    PJson() {
        super("JSON", Types.OTHER, String.class, null, 48);
    }

    PJson(String sqlTypeName, int sqlType, Class clazz, PDataCodec codec, int ordinal) {
    ...
    public boolean isCoercibleTo(PDataType targetType) {
        return equalsAny(targetType, this, PChar.INSTANCE, PVarchar.INSTANCE, PJson.INSTANCE, PJsonDC.INSTANCE);
    }
