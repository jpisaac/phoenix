 ...
 */
public class PJsonDC extends PJson {

    public static final PJsonDC INSTANCE = new PJsonDC();

    PJsonDC() {
        super("JSONDC", Types.OTHER, String.class, null, 49);
    }
...
//            return null;
//        }
//        if (equalsAny(actualType, PJsonDC.INSTANCE)) {
//            return object;
//        }
...
//                                    @SuppressWarnings("rawtypes") PDataType srcType, SortOrder sortOrder,
//                                    Integer maxLength, Integer scale,
//                                    Integer desiredMaxLength, Integer desiredScale) {
//        return PVarchar.INSTANCE.isSizeCompatible(ptr, value, srcType, sortOrder, maxLength, scale,
...
//        if (PJsonDC.INSTANCE != rhsType) {
//            throwConstraintViolationException(rhsType, this);
//        }
//        throw new EqualityNotSupportedException(PJsonDC.INSTANCE);
//    }
//
//    @Override
...
//        return otherType == PJsonDC.INSTANCE || otherType == PVarchar.INSTANCE;
//    }
//
//    @Override
