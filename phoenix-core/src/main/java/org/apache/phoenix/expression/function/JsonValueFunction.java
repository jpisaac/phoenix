 ...
 *
 */
@FunctionParseNode.BuiltInFunction(name = JsonValueFunction.NAME, nodeClass = JsonValueParseNode.class,
        args = {
                @FunctionParseNode.Argument(allowedTypes = { PVarchar.class, PJson.class }),
...
public class JsonValueFunction extends ScalarFunction {
    ...
    public JsonValueFunction(List<Expression> children, String jsonPath) {
        super(children);
