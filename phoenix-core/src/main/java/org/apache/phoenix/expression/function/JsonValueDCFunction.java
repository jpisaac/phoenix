 ...
 *
 */
@FunctionParseNode.BuiltInFunction(name = JsonValueDCFunction.NAME, nodeClass = JsonValueDCParseNode.class,
        args = {
                @FunctionParseNode.Argument(allowedTypes = { PVarchar.class, PJsonDC.class}),
                @FunctionParseNode.Argument(allowedTypes = { PVarchar.class }) })
public class JsonValueDCFunction extends ScalarFunction {

    public static final String NAME = "JSON_VALUE_DC";
    private String jsonPath;

    // This is called from ExpressionType newInstance
    public JsonValueDCFunction() {

    }

    public JsonValueDCFunction(List<Expression> children, String jsonPath) {
        super(children);
