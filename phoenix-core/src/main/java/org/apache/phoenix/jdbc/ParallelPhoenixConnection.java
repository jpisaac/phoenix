...
public class ParallelPhoenixConnection implements PhoenixMonitoredConnection {
    ...
    public ParallelPhoenixConnection(ParallelPhoenixContext context) throws SQLException {
        ...
        LOG.debug("First Url: {} Second Url: {}", context.getHaGroup().getGroupInfo().getUrl1(),
    ...
    @VisibleForTesting
    ParallelPhoenixConnection(ParallelPhoenixContext context, CompletableFuture<PhoenixConnection> futureConnection1, CompletableFuture<PhoenixConnection> futureConnection2) {
        this.context = context;
    ...
    public void close() throws SQLException {
        ...
        CompletableFuture<FutureResult<CompletableFuture<Boolean>>> closeFuture1 =
                context.getChainOnConn1().handle((obj, e) -> {
                    return CompletableFuture.supplyAsync(closeSupplier1);
                }).thenApply(t -> new FutureResult<>(t, 0));
        CompletableFuture<FutureResult<CompletableFuture<Boolean>>> closeFuture2 =
        ...
        FutureResult<CompletableFuture<Boolean>> result =
                (FutureResult<CompletableFuture<Boolean>>) ParallelPhoenixUtil.INSTANCE
                        .getAnyOfNonExceptionally(Arrays.asList(closeFuture1, closeFuture2), context);
