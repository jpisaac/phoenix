...
/**
 * ResultSet suitable for truly immutable use cases that do not delete data. Returns a non-null
 * value when possible. Checks result from both the underlying clusters for nulls(empty result). If
