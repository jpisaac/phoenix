...
public final class PhoenixConfigurationUtil {
    ...
    // phoenix ttl data deletion job for all child/children views based on a given table
    public static final String MAPREDUCE_PHOENIX_TTL_DELETE_JOB_PER_TABLE = "phoenix.mapreduce.view_ttl.table";
