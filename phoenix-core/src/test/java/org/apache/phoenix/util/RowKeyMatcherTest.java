...
import org.apache.phoenix.coprocessor.RowKeyMatcher;
import org.apache.phoenix.coprocessor.TableTTLInfo;
import org.apache.phoenix.coprocessor.TableTTLInfoCache;
...
public class RowKeyMatcherTest {
  ...
  public List<TableTTLInfo> getSampleData() {
    ...
    tableList
      .add(new TableTTLInfo("TEST_ENTITY.T_000001", "", "TEST_ENTITY.GV_000001", "001", 30000));
    tableList
      .add(new TableTTLInfo("TEST_ENTITY.T_000001", "", "TEST_ENTITY.GV_000002", "002", 60000));
    tableList
      .add(new TableTTLInfo("TEST_ENTITY.T_000001", "", "TEST_ENTITY.GV_000003", "003", 60000));
    tableList.add(new TableTTLInfo("TEST_ENTITY.T_000001", "00D0t0001000001", "TEST_ENTITY.Z01",
      "00D0t0001000001Z01", 60000));
    tableList.add(new TableTTLInfo("TEST_ENTITY.T_000001", "00D0t0002000001", "TEST_ENTITY.Z01",
      "00D0t0002000001Z01", 120000));
    tableList.add(new TableTTLInfo("TEST_ENTITY.T_000001", "00D0t0003000001", "TEST_ENTITY.Z01",
      "00D0t0003000001Z01", 180000));
    tableList.add(new TableTTLInfo("TEST_ENTITY.T_000001", "00D0t0004000001", "TEST_ENTITY.Z01",
      "00D0t0004000001Z01", 300000));
    tableList.add(new TableTTLInfo("TEST_ENTITY.T_000001", "00D0t0005000001", "TEST_ENTITY.Z01",
      "00D0t0005000001Z01", 6000));
    return tableList;
  }
  ...
  public void testOverlappingPrefixes() {
    ...
    TableTTLInfo table1 =
      new TableTTLInfo("TEST_ENTITY.T_000001", "", "TEST_ENTITY.GV_000001", "001", 30000);
    TableTTLInfo table2 = new TableTTLInfo("TEST_ENTITY.T_000001", "0010t0001000001",
      "TEST_ENTITY.Z01", "0010t0001000001002Z01", 60000);
    ...
    assertTrue(String.format("row-%d, matched = %s, row = %s", 0, row0GlobalMatch != null,
      sampleRows.get(0)), row0GlobalMatch != null);
    Integer row0TenantMatch = tenantRowKeyMatcher.get(sampleRows.get(0).getBytes(), tenantOffset);
    assertTrue(String.format("row-%d, matched = %s, row = %s", 0, row0TenantMatch != null,
      sampleRows.get(0)), row0TenantMatch == null);

    Integer row1GlobalMatch = globalRowKeyMatcher.get(sampleRows.get(1).getBytes(), globalOffset);
    assertTrue(String.format("row-%d, matched = %s, row = %s", 0, row1GlobalMatch != null,
      sampleRows.get(1)), row1GlobalMatch == null);
    Integer row1TenantMatch = tenantRowKeyMatcher.get(sampleRows.get(1).getBytes(), tenantOffset);
    assertTrue(String.format("row-%d, matched = %s, row = %s", 0, row1TenantMatch != null,
      sampleRows.get(1)), row1TenantMatch != null);
  }
  ...
  public void testSamplePrefixes() {
    ...
    sampleTableList.add(new TableTTLInfo("TEST_ENTITY.T_000001".getBytes(),
      ...
      Bytes.toBytesBinary("\\x7F\\xFF\\xFF\\xFF\\xFF\\xFF\\x80\\x00"), 300));
    sampleTableList.add(new TableTTLInfo("TEST_ENTITY.T_000001".getBytes(),
      ByteUtil.EMPTY_BYTE_ARRAY, "TEST_ENTITY.GV_000002".getBytes(),
      Bytes.toBytesBinary("\\x7F\\xFF\\xFF\\xFF\\xFF\\xFF\\x80\\x01"), 300));
    sampleTableList.add(new TableTTLInfo("TEST_ENTITY.T_000001".getBytes(),
      ByteUtil.EMPTY_BYTE_ARRAY, "TEST_ENTITY.GV_000003".getBytes(),
      Bytes.toBytesBinary("\\x7F\\xFF\\xFF\\xFF\\xFF\\xFF\\x80\\x02"), 300));
    sampleTableList.add(new TableTTLInfo("TEST_ENTITY.T_000001".getBytes(),
      ByteUtil.EMPTY_BYTE_ARRAY, "TEST_ENTITY.GV_000004".getBytes(),
      Bytes.toBytesBinary("\\x7F\\xFF\\xFF\\xFF\\xFF\\xFF\\x80\\x03"), 300));
    sampleTableList.add(new TableTTLInfo("TEST_ENTITY.T_000001".getBytes(),
      ByteUtil.EMPTY_BYTE_ARRAY, "TEST_ENTITY.GV_000005".getBytes(),
      Bytes.toBytesBinary("\\x7F\\xFF\\xFF\\xFF\\xFF\\xFF\\x80\\x04"), 300));

    sampleTableList.add(new TableTTLInfo("TEST_ENTITY.T_000001".getBytes(),
      ByteUtil.EMPTY_BYTE_ARRAY, "TEST_ENTITY.GV_000006".getBytes(),
      Bytes.toBytesBinary("\\x7F\\xFF\\xFF\\xFF\\xFF\\xFF\\x80\\x8F"), 300));
    sampleTableList.add(new TableTTLInfo("TEST_ENTITY.T_000001".getBytes(),
      ByteUtil.EMPTY_BYTE_ARRAY, "TEST_ENTITY.GV_000007".getBytes(),
      Bytes.toBytesBinary("\\x7F\\xFF\\xFF\\xFF\\xFF\\xFF\\x80\\x9F"), 300));
    sampleTableList.add(new TableTTLInfo("TEST_ENTITY.T_000001".getBytes(),
      ByteUtil.EMPTY_BYTE_ARRAY, "TEST_ENTITY.GV_000008".getBytes(),
      Bytes.toBytesBinary("\\x7F\\xFF\\xFF\\xFF\\xFF\\xFF\\x80\\xAF"), 300));
    sampleTableList.add(new TableTTLInfo("TEST_ENTITY.T_000001".getBytes(),
      ByteUtil.EMPTY_BYTE_ARRAY, "TEST_ENTITY.GV_000009".getBytes(),
      Bytes.toBytesBinary("\\x7F\\xFF\\xFF\\xFF\\xFF\\xFF\\x80\\xBF"), 300));
    sampleTableList.add(new TableTTLInfo("TEST_ENTITY.T_000001".getBytes(),
      ByteUtil.EMPTY_BYTE_ARRAY, "TEST_ENTITY.GV_0000010".getBytes(),
      Bytes.toBytesBinary("\\x7F\\xFF\\xFF\\xFF\\xFF\\xFF\\x80\\xCF"), 300));
    sampleTableList.add(new TableTTLInfo("TEST_ENTITY.T_000001".getBytes(),
      ByteUtil.EMPTY_BYTE_ARRAY, "TEST_ENTITY.GV_000011".getBytes(),
      Bytes.toBytesBinary("\\x7F\\xFF\\xFF\\xFF\\xFF\\xFF\\x80\\xDF"), 300));
    sampleTableList.add(new TableTTLInfo("TEST_ENTITY.T_000001".getBytes(),
      ByteUtil.EMPTY_BYTE_ARRAY, "TEST_ENTITY.GV_000012".getBytes(),
      Bytes.toBytesBinary("\\x7F\\xFF\\xFF\\xFF\\xFF\\xFF\\x80\\xEF"), 300));
    ...
    int offset = 0;
    for (int i = 0; i < sampleTableList.size(); i++) {
      assertEquals(rowKeyMatcher.get(sampleTableList.get(i).getMatchPattern(), offset).intValue(),
        i);
    }
  ...
  private void assertResults(RowKeyMatcher rowKeyMatcher, List<TableTTLInfo> sampleTableList) {
    ...
    String message =
      String.format("expected = %d, actual = %d", tableCountExpected, prefixCountActual);
  ...
  private void assertResults(TableTTLInfoCache cache, List<TableTTLInfo> sampleTableList) {
    ...
    String message =
      String.format("expected = %d, actual = %d", tableCountExpected, tableCountActual);
