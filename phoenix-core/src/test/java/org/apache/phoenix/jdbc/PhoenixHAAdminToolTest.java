...
public class PhoenixHAAdminToolTest {
    ...
    public void testHelpMessage() throws Exception {
        ...
        PhoenixHAAdminTool.OPTIONS.getOptions().forEach(
                (o) -> assertTrue(STDOUT_CAPTURE.toString().contains(((Option) o).getArgName())));
    }

    @Test
    public void testGetZookeeperQuorum() {
        Configuration conf = HBaseConfiguration.create();
        // default local ZK is localhost:2181:/hbase
        final String localZk = String.format("localhost:%d:%s",
